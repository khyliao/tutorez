    ...
    extend: {
      boxShadow: {
        ...
        lessonCardInfoTabletAndMore:
          "1px 4px 20px 0px rgba(0, 0, 0, 0.02), 3px 5px 60px 0px rgba(0, 0, 0, 0.03), 4px 0px 5px 0px rgba(0, 0, 0, 0.04), 3px 2px 10px 0px rgba(0, 0, 0, 0.04), 6px 3px 10px 0px rgba(0, 0, 0, 0.05), 3px 0px 25px 0px rgba(0, 0, 0, 0.07)",
        ...
        lessonCardInfoTabletAndMoreDark:
          "1px 4px 20px 0px rgba(173, 183, 255, 0.06), 3px 5px 60px 0px rgba(173, 183, 255, 0.03), 4px 0px 5px 0px rgba(173, 183, 255, 0.03), 3px 2px 10px 0px rgba(173, 183, 255, 0.04), 6px 3px 10px 0px rgba(173, 183, 255, 0.12), 3px 0px 25px 0px rgba(173, 183, 255, 0.15)",
      },
      spacing: {
      ...
      backgroundImage: {
        "recommendation-course-eng":
          "url('/assets/recommendation-course-eng-bg.svg')",
        "recommendation-course-maths":
          "url('/assets/recommendation-course-maths-bg.svg')",
        "linear-main":
