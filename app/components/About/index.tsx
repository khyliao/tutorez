...
const About = () => {
  ...
  return (
    <section className="flex flex-col items-center mb-24 px-4" id="about">
      ...
      <p className="mb-8 text-xs lg:text-[22px] lg:px-20 text-[#525151] lg:mb-24 text-center font-open-sans leading-5 lg:leading-8 tracking-wide ">
        {t[lang].about.paragraph}
      </p>
      <ul className="flex flex-col md:flex-row gap-7 md:gap-12 items-center md:items-start">
        <li className="max-w-[250px] md:max-w-[200px] lg:max-w-[300px] flex flex-col items-center">
          ...
          <h3 className="mb-2 uppercase font-poppins text-base xl:text-xl leading-6 font-medium text-[#333333]">
