...
const Review = () => {
  ...
  return (
    <section
      ...
      id="reviews"
    >
      <h2 className="mb-7 px-2 lg:mb-12 lg:text-4xl text-center text-[#333] font-open-sans font-extrabold tracking-wide text-2xl leading-9">
        {t[lang].review.title}
      </h2>
      <Swiper
        pagination={{
      ...
      <div className="mt-9 mb-6 max-w-[290px] mx-auto flex flex-col md:px-2 md:max-w-[900px]">
        <Image
