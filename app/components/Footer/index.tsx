    ...
    <footer className='bg-footer pt-5 pb-4'>
      <div className='px-4 lg:px-6 xl:px-8 lg:flex lg:flex-row'>
        ...
        <div className='flex flex-col lg:flex-row gap-8'>
          <form
            className='flex flex-col max-w-[260px] xl:max-w-none md:w-[260px] xl:w-[350px] md:mr-36 lg:mr-20 xl:mr-28 2xl:mr-40'
          ...
          <div className='mb-10 flex flex-wrap gap-6 lg:flex-nowrap pr-2 justify-between text-white md:gap-36 lg:gap-20 xl:flex xl:gap-32 2xl:gap-44'>
            <div>
            ...
            <div>
              <p className='mb-5 text-base lg:text-lg leading-5 font-bold'>
                {t[lang].footer.term.title}
              </p>
              <ul className='flex flex-col gap-4'>
                {t[lang].footer.term.terms.map((term) => (
                  <li key={term[0]} className='text-sm lg:text-base'>
                    <Link
                      className='block w-full h-full lg:hover:underline'
                      href={`/${term[1]}`}
                    >
